...
var project = document.querySelectorAll("div.progect");
project[0].onclick = function () {
  "use strict"
  window.open("panorama.html");
};

var liLink = document.querySelectorAll("div#reservation li");
liLink[2].onclick = function () {
  "use strict"
  window.open("panorama.html");
};
